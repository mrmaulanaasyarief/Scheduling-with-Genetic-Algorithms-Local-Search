...
class DisplayMgr:
    ...
    def print_generation(self, population):
        table1 = prettytable.PrettyTable(['schedule #', 'fitness', '# of conflicts', 'clasess [dept,class,room,instructor'])
        # schedules = population.get_schedule()
        # for i in range(0, len (schedules)):
        #     table1.add_row([str(i), round(schedulesp[i].get_fitness(),3), schedules[i].get_numbOfConflicts()])
        # print(table1)
